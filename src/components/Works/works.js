    ...
    return (
        <section className="h-[100vh] w-full flex flex-col items-center pl-[30px] pr-[30px] justify-around">
            ...
            <div className="flex flex-row h-[350px] justify-around items-center w-full">
                ...
                <section className="flex flex-row h-full w-[1100px] gap-x-[50px]">
                    <div style={{backgroundImage: "url('/obc-preview.png')"}} className="h-full w-[550px] bg-no-repeat bg-cover">
