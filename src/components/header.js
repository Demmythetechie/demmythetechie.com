...
function Header(){
    ...
    return (
        <div className="max-[800px]:absolute max-[800px]:z-30 max-[800px]:top-[0%] flex flex-row items-center justify-between h-[10vh] w-full pl-[8vh] pr-[8vh] max-[800px]:justify-between max-[800px]:pr-[0vh] max-[800px]:pl-[0vh]">
            ...
            <div onClick={nav} className="max-[800px]:mr-[5vw] min-[801px]:hidden max-[800px]:flex items-center justify-center w-[4%] h-[45%] max-[480px]:w-[7%]">
                <svg viewBox="0 0 100 100">
                    <line x1="0" y1="25" x2="100" y2="25" stroke="#ffffff" strokeWidth="7" strokeLinecap="round"/>
                    <line x1="0" y1="50" x2="70" y2="50" stroke="#ffffff" strokeWidth="7" strokeLinecap="round"/>
                    <line x1="0" y1="75" x2="90" y2="75" stroke="#ffffff" strokeWidth="7" strokeLinecap="round"/>
                </svg>
            </div>
